...
#### [Cloud-Native Vector Search v2: S3-Optimized Partitioned HNSW](./projects/s3-index-v2.html)
An updated approach to cloud-native vector similarity search using S3-optimized partitioned HNSW indexes. This version refines the hierarchical partitioning strategy and query routing for improved latency and recall at billion-scale deployments.
